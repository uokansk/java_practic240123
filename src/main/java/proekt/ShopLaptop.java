...
public class ShopLaptop {
    ...
    public boolean laptopIsCorrect(Laptops laptop) {

        for (Criterion criterion : criterionList) {
            Object valueLaptop = null;

            if (criterion.property.equals("id")) {
                valueLaptop = laptop.getId();
            } else if (criterion.property.equals("SizeRAM")) {
                valueLaptop = laptop.getSizeRAM();
            } else if (criterion.property.equals("OperatingSys")) {
                valueLaptop = laptop.getOperatingSys();
            } else if (criterion.property.equals("SizeHardDisk")) {
                valueLaptop = laptop.getSizeHardDisk();
    ...
    public ShopLaptop(Set<Laptops> laptops) {
        this.scanner = new Scanner(System.in);
        this.laptops = laptops;
    }

    public ShopLaptop(Set<Laptops> laptops, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.laptops = laptops;
    ...
    public Map<String, String> descriptionsProperties() {
        ...
        map.put("id", "ID");
        map.put("SizeRAM", "Объем оперативной памяти");
        map.put("OperatingSys", "Операционная система");
        map.put("SizeHardDisk", "размер жеского диска");
        map.put("price", "цена");
